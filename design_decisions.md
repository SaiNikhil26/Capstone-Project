...
**Decision:** Use a **hardcoded Python pipeline** ([recommend_logic.py](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/api/core/recommend_logic.py)) instead of an LLM-based orchestrator agent that decides which agents to call.
...
**Decision:** Run [SkillGapAgent](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/app_agents/skill_gap_agent.py#83-133) and [CareerAgent](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/app_agents/career_agent.py#74-128) simultaneously using **`asyncio.gather`**.
...
**Decision:** Structure the React frontend around **4 single-responsibility components**: [SearchBar](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/SearchBar.jsx#5-38), [CareerCard](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/CareerCard.jsx#4-24), [AdvisorCard](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/AdvisorCard.jsx#4-60), [CourseList](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/CourseList.jsx#4-61).

| Component | Renders |
|---|---|
| [SearchBar](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/SearchBar.jsx#5-38) | Query input + loading state |
| [CareerCard](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/CareerCard.jsx#4-24) | Career track + alignment reason |
| [AdvisorCard](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/AdvisorCard.jsx#4-60) | Advisor summary, study tips, skill gap tags |
| [CourseList](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/frontend/careerguidefrontend/src/components/CourseList.jsx#4-61) | Difficulty-staged pathway with course cards |
...
**Decision:** Create a **[get_logger(name)](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/logger.py#6-49)** factory in [Source/logger.py](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/logger.py) that writes structured timestamped logs to both the console and a per-module `.log` file under `logs/`.
...
## 12. Environment Configuration — [Source/.env](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/.env) Loaded Before SDK Import

**Decision:** Call `load_dotenv()` **before** any `from agents import ...` or `from langchain_openai import ...` import.

**Why?**
The OpenAI Agents SDK initialises its trace exporter at **import time** and reads `OPENAI_API_KEY` from `os.environ` in that moment. If `load_dotenv()` runs after the import, the trace exporter sees an empty key and logs `"skipping trace export"` — even though the key exists in [Source/.env](file:///c:/Users/Administrator/FDE%20Training/Capstone_Project/Source/.env). Loading the env first ensures the key is in `os.environ` before any SDK code runs.
